...
public class FontUtils {
  ...
  private static void initTypefaces(AssetManager assetsManager) {
    if (normal == null || bold == null || condensed == null || light == null) {
      normal = loadTypeface(assetsManager, "fonts/ss_normal.ttf");
      bold = loadTypeface(assetsManager, "fonts/ss_bold.ttf");
      condensed = loadTypeface(assetsManager, "fonts/ss_normal.ttf");
      light = loadTypeface(assetsManager, "fonts/ss_light.ttf");
    }
  }
  
  private static Typeface loadTypeface(AssetManager assetsManager, String path) {
    try {
      return Typeface.createFromAsset(assetsManager, "fonts/ss_normal.ttf"); 
