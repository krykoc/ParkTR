...
public class DemoClusterOptionsProvider implements ClusterOptionsProvider {
	...
	private static final int[] res = { R.drawable.new_green_closed, R.drawable.new_yellow_closed, R.drawable.new_red_closed, R.drawable.m4, R.drawable.m5 };
	...
	public DemoClusterOptionsProvider(Resources resources) {
		...
		paint.setTextSize(resources.getDimension(R.dimen.cluster_text_size_large));
	}
	...
	public ClusterOptions getClusterOptions(List<Marker> markers) {
		...
		String text = String.valueOf(sumOfAvailableParkingLot);
